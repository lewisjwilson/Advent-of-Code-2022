...
# As your boats approach land, the Elves begin taking inventory of their supplies. One important consideration is food - in particular, the number of Calories 
...
# Preformatting with online Regex find and replace
calories = [2494,
8013,
...,
...,
...
print(f"Elf {elves.index(max(elves)) + 1} is carrying {max(elves)} calories!")
